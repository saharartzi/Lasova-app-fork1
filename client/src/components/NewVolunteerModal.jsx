    ...
    <>
      <Modal open={props.open} onClose={() => props.setOpen(false)}>
        <Box className="new_vol_modal">
          ...
          <h1 className="new_vol_title">
            {props.modalStatus === 'New' ? 'רישום מתנדב חדש' : 'עדכון נתוני מתנדב'}
          </h1>
          ...
          <div className="new_vol_modal_content">
            ...
            <form className="new_vol_modal_form" onSubmit={handleSubmit}>
              ...
              <label htmlFor="address" className="new_vol_modal_label">כתובת*</label>
                <input
                  className="input"
                  type="text"
                  id="address"
              ...
              <div className="center">
                ...
                <div className='grouping'>
                  ...
                  <div className="gender_group"  >
                    <span className="gender_btns">
                      <input type="radio" value="זכר" name="gender" checked={newVolunteer.gender === 'זכר'} onChange={handleEditFileds} />
                      <label htmlFor="male">זכר</label>
                    </span>
                    <span className="gender_btns">
                      <input type="radio" value="נקבה" name="gender" checked={newVolunteer.gender === 'נקבה'} onChange={handleEditFileds} />
                      <label htmlFor="female">נקבה</label>
                    </span>
                    <span className="gender_btns">
                      <input type="radio" value="אחר" name="gender" checked={newVolunteer.gender === 'אחר'} onChange={handleEditFileds} />
                ...
                <div className='grouping'>
                  ...
                  <div className="gender_group"  >
                    <span className="gender_btns">
                      <input type="radio" value="יש" name="hasDrivingLicence" checked={newVolunteer.hasDrivingLicence === 'יש'} onChange={handleEditFileds} />
                      <label htmlFor="has">יש</label>
                    </span>
                    <span className="gender_btns">
                      <input type="radio" value="אין" name="hasDrivingLicence" checked={newVolunteer.hasDrivingLicence === 'אין'} onChange={handleEditFileds} />
                ...
                <div className='grouping'>
                  ...
                  <div className="gender_group"  >
                    <span className="gender_btns">
                      <input type="radio" value="כן" name="availableInEmergency" checked={newVolunteer.availableInEmergency === 'כן'} onChange={handleEditFileds} />
                      <label htmlFor="canemergency">כן</label>
                    </span>
                    <span className="gender_btns">
                      <input type="radio" value="לא" name="availableInEmergency" checked={newVolunteer.availableInEmergency === 'לא'} onChange={handleEditFileds} />
                ...
                <TextareaAutosize type="text" value={newVolunteer.talkSummary} name="talkSummary" className="summary_text" onChange={handleEditFileds} />
              </div>
              ...
              <div className="left">
                <div>
                  <>
                    ...
                    <select name="volunteeringProgram" value={newVolunteer.volunteeringProgram} className="input" onChange={handleEditFileds}>
                  ...
                  <select name="volunteerType" className="input" value={newVolunteer.volunteerType} onChange={handleEditFileds} >
                    ...
                    <>
                      <div className="student_group">
                        <span className="student_btns">
                          <input type="checkbox" value="נקז" name="studentoption" studentoption="student" checked={newVolunteer.studentoption === 'נקז'} onChange={handleEditFileds} />
                          <label htmlFor="nakaz">נק"ז</label>
                        </span>
                        <span className="student_btns">
                          <input type="checkbox" value="מלגה" name="studentoption" studentoption="student" checked={newVolunteer.studentoption === 'מלגה'} onChange={handleEditFileds} />
                          <label htmlFor="milga">מלגה</label>
                        </span>
                      </div>
                      <label className="new_vol_modal_label">מקום לימודים</label>
                      <input className="input" type="text" value={newVolunteer.educationalInstitution} name="educationalInstitution" required onChange={handleEditFileds} />
                  ...
                  {newVolunteer.volunteerType === 'שלצ' && (
                    <>
                      ...
                      <input className="input" type="text" value={newVolunteer.officerPhone} name="officerPhone" required onChange={handleEditFileds} />
                    </>
                  )}
